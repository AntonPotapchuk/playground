...
def featurize(obs):
    ...
    return dict(f1=np.concatenate((board, bomb_blast_strength, bomb_life, position, ammo, blast_strength, can_kick, teammate, enemies)))
...
network = dict(type='rl_agent.custom_network.CustomNetwork')
states = {"t1": dict(shape=(2,), type='float'), "t2": dict(shape=(2,), type='float')}
